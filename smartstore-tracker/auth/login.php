    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                header('Location: /smartstore-tracker/dashboard.php'); // Redirect to dashboard
                exit();
            } else {
...
<head>
    ...
    <title>Login - SmartStore Tracker</title>
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8 p-8">
        ...
        <form class="mt-8 space-y-6" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    <label for="username" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Username or Email</label>
